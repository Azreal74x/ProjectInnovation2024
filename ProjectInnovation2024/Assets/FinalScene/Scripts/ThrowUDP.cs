...
public class ThrowUDP : MonoBehaviour {
  ...
  private FMOD.Studio.EventInstance doorExplode;
  [FMODUnity.EventRef][SerializeField] private string fmodDoorExplode;
  ...
  void Start() {
    ...
    doorExplode = FMODUnity.RuntimeManager.CreateInstance(fmodDoorExplode);
  }
