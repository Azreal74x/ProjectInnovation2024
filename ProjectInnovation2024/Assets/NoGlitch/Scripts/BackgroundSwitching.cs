...
public class BackgroundSwitching : MonoBehaviour {
  ...
  [SerializeField] public int currentScreen = 0;
  ...
  private FMOD.Studio.EventInstance wallSwitchSound;
  [FMODUnity.EventRef][SerializeField] private string fmodWallSwitchSound;
  ...
  void Start() {
    ...
    wallSwitchSound = FMODUnity.RuntimeManager.CreateInstance(fmodWallSwitchSound);
  }
